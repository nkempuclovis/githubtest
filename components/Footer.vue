    ...
    <div>
      <footer class="site-footer">
                          ...
                          <div class="row">
                              <div class="col-xl-3 col-lg-6 col-sm-12">
                                  <div class="footer-widget footer-widget__contact">
                                      <h2 class="footer-widget__title">Schools</h2><!-- /.footer-widget__title -->
                                      <ul class="list-unstyled footer-widget__link-list">
                                          <li>
                                              <a href="/program">School of Health & Science</a>
                                            
                                          </li>
                                          <li>
                                            <a href="program"> School of Business Technology </a>
                                             
                                          </li>
                                           <li>
                                            <a href="program"> School of Education & Teaching </a>
                  ...
                  <div class="site-footer__bottom">
                      <div class="container">
                          <p class="site-footer__copy">&copy; Copyright 2020 by <a href="#">uihbtedu.com</a></p>
