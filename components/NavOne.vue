              ...
              <div class="container clearfix">
                  ...
                  <div class="logo-box clearfix">
                      <a class="navbar-brand" href="/">
                          <img src="/assets/images/hihb-logo.jpg" class="main-logo" width="128" alt="Awesome Image" />
                      </a>
                  ...
                  <div class="main-navigation">
                      <ul class=" navigation-box">
                          ...
                          <li>
                              <nuxt-link to="/courses">Prospective Students</nuxt-link>
                              <ul class="sub-menu">
                          ...
                          <li>
                              <nuxt-link to="/teachers">Current Students</nuxt-link>
                              <ul class="sub-menu">
                           ...
                           <li>
                              <nuxt-link to="/teachers">Faculty & Staffs</nuxt-link>
                              <ul class="sub-menu">
                                  <li><nuxt-link to="/teachers">Teachers</nuxt-link></li>
                                  <li><nuxt-link to="/teacher-details">Teachers Details</nuxt-link></li>
                                  <li><nuxt-link to="/become-teacher">Become Teacher</nuxt-link></li>
