              ...
              <div class="col-lg-4">
                  <div class="blog-one__single">
                      ...
                      <div class="blog-one__content text-center">
                          ...
                          <h2 class="blog-one__title"><nuxt-link to="/news-details">Child birth in Cameroon</nuxt-link>
                          </h2><!-- /.blog-one__title -->
              ...
              <div class="col-lg-4">
                  <div class="blog-one__single">
                      ...
                      <div class="blog-one__content text-center">
                          ...
                          <h2 class="blog-one__title"><nuxt-link to="/news-details">Development & Governance in Africa
                                </nuxt-link>
                          </h2><!-- /.blog-one__title -->
                          <p class="blog-one__text">Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit
                              amet finibus eros.</p><!-- /.blog-one__text -->
